        ...
        <div class="contact__form">
            <div class="contact__map">
                <div class="container d-flex justity-center">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15757.789469203626!2d-76.9865961989838!3d-12.063847578720992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c66820eb9773%3A0x70f01c7a79dc1633!2sAv.%20Nicol%C3%A1s%20Ayll%C3%B3n%202480%2C%20Ate%2015022!5e0!3m2!1ses-419!2spe!4v1634995343643!5m2!1ses-419!2spe"
                        width="80%" height="320" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
                    ...
                    <div class="contactsmall__content">
                        ...
                        <form action="{{ route('admin.contact.store') }}" class="contactsmall__form" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <input type="text" placeholder="DNI o RUC" name="dniruc">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                            ...
                            <div class="contactsmall__buttons">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1" style="font-size: 11px">Acepto
